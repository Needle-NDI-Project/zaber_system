...
namespace zaber_driver
{
    ...
    ZaberSystemHardwareInterface::on_init(const hardware_interface::HardwareInfo &info)
    {
        ...
        try
        {
            connection_ = zaber::motion::ascii::Connection::openSerialPort("/dev/ttyUSB0");
        }
    ...
    ZaberSystemHardwareInterface::prepare_command_mode_switch(const std::vector<std::string> &start_interfaces,
    ...
    hardware_interface::return_type
    ZaberSystemHardwareInterface::perform_command_mode_switch(const std::vector<std::string> &start_interfaces,
                                                              const std::vector<std::string> &stop_interfaces)
    {
